...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header
      className="sticky top-0 z-30 w-full min-h-[56px] h-[56px] px-4 md:px-6 flex items-center justify-between border-b border-white/60 bg-white/40 backdrop-blur-md"
    >
